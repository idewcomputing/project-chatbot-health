...
{% tab title="⦿ EXAMPLE" %}
![This is only an example template to inspire structure where text and images could be inserted for each element. Your version may not have as many artifacts or sections.](https://github.com/idewcomputing/project-chatbot-health/tree/05b79c907d317e02f09936002944a0bfdfbffd18/.gitbook/assets/poster-template-36x24-2.png)
{% endtab %}
